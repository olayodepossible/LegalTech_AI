"""
Structured JSON logs for CloudWatch (same contract as database/src/flow_log.py).

Keep field names in sync with backend/database/src/flow_log.py for shared Insights queries.
"""
