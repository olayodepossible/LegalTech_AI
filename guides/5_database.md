...
In this guide, we'll set up Aurora Serverless v2 PostgreSQL with the Data API and create a reusable database library that all our AI agents will use.
...
2. For **Policy name**, enter: `AlexRDSCustomPolicy`
3. For **Description**, enter: `RDS and Data API permissions for Alex project`
...
1. **Verify secrets** (the secret name includes a random suffix):
