...
This first guide focuses on setting up the necessary AWS permissions. We'll create a dedicated IAM group with only the permissions needed for the LegalTech project.
...
2. For **Policy name**, enter: `AlexS3VectorsAccess`
3. For **Description**, enter: `Full access to S3 Vectors for Alex project`
...
cd into the cloned project  # or wherever you cloned the repo
